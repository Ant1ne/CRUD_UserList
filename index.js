//Read operation with AJAX - Asynchronous JavaScript And XML - with GET method
function loadTable() {
  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      for (let object of objects) {
        ...
        trHTML +=
          '<td><button type="button" class="btn btn-outline-secondary m-1" onclick="showUserEditBox(' +
          object["id"] +
          ')">Edit</button>';
        trHTML +=
          '<button type="button" class="btn btn-outline-danger m-1" onclick="userDelete(' +
          object["id"] +
          ')">Delete</button></td>';
        trHTML += "</tr>";
      }
...
// Create operation with POST method
...
// Update operation with PUT method
    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      Swal.fire({
        ...
        html:
          ...
          user["id"] +
          ">" +
          '<input id="fname" class="swal2-input" placeholder="First Name" value="' +
          user["fname"] +
          '">' +
          '<input id="lname" class="swal2-input" placeholder="Last Name" value="' +
          user["lname"] +
          '">' +
